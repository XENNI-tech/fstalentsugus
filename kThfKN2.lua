...
local tabs = {
	info = {
        ...
        ui_groups.info:button("   Discord server   ", function()
			shellexecutea(nil, "open", "https://discord.gg/rollmops", nil, nil, 1)
		end)
	},
	main = {
...
utils.execute_after(1, function ()
	network.get("https://raw.githubusercontent.com/civiltox/help/main/grenades.json", {}, function(response)
...
utils.execute_after(2, function ()
	network.get("https://raw.githubusercontent.com/civiltox/help/main/movements.json", {}, function(response)
		local body = tostring(response)
...
utils.execute_after(3, function ()
	network.get("https://raw.githubusercontent.com/civiltox/help/main/wallbangs.json", {}, function(response)
		local body = tostring(response)
